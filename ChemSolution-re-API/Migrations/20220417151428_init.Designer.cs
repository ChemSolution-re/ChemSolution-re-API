...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChemSolution_re_API.Entities.Valence", b =>
                {
                    b.Property<int>("ValenceId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElementValence", b =>
                {
                    b.Property<int>("ElementsElementId")
                        .HasColumnType("int");

                    b.Property<int>("ValencesValenceId")
                        .HasColumnType("int");

                    b.HasKey("ElementsElementId", "ValencesValenceId");

                    b.HasIndex("ValencesValenceId");

                    b.ToTable("ElementValence");
                });
            ...
            modelBuilder.Entity("ElementValence", b =>
                {
                    ...
                    b.HasOne("ChemSolution_re_API.Entities.Valence", null)
                        .WithMany()
                        .HasForeignKey("ValencesValenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
